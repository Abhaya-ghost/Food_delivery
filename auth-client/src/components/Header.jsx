        ...
        <div className="grid grid-cols-1 relative lg:grid-cols-2 gap-8 items-center">
          <div className='lg:w-[32rem] w-full flex flex-col space-y-6'>
            ...
            <div className="lg:text-xl text-[#191919] md:text-lg text-base">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias repudiandae aliquid, ab vel quos dolorum praesentium beatae iure soluta suscipit. Fugiat nostrum asperiores dolor dolore cupiditate! Voluptates ad provident quia dolore veritatis porro dignissimos dolorem vitae delectus iure doloremque, quas eaque error id eveniet odio sunt, iste autem itaque modi.
            </div>
            ...
            <div className="flex gap-8 items-center">
              ...
              <div className="sm:flex hidden gap-4 items-center ">
                ...
                <div className="lg:text-xl tet[#191919] md:text-lg text-base cursor-pointer">
                  Watch Now
                </div>
              </div>
          ...
          <img src={header} className='h-[37.5rem] mx-auto justify-end ' />
        </div>
      </div>
    </div>
  )
